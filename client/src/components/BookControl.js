...
class BookControl extends Component {
    ...
    componentDidMount(){
        axios.get('http://34.35.116.179:5000/api/books')
            .then(res =>{
                this.setState({
    ...
    handleAddingNewBook = (newBook) => {
        axios.post('http://34.35.116.179:5000/api/books/', newBook)
            .then(res => {
            this.setState(prevState => ({
    ...
    handleDeletingBook = (id) =>{
        axios.delete('http://34.35.116.179:5000/api/books/'+id)
    ...
    handleEditingBook = (editedBook) =>{
        axios.put('http://34.35.116.179:5000/api/books/' + this.state.selectedBook._id, editedBook)
            .then(res =>console.log(res.data))
